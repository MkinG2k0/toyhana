...
export const NewVenueForm = () => {
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    try {
      ...
      toast.success("Зал добавлен и отправлен на проверку")
    ...
    <div className="mx-auto max-w-2xl">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          После добавления зал будет отправлен на проверку администратором
        </p>
      </div>
        ...
        <Card className="border-surface-200">
          ...
          <CardContent>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Загрузите несколько фото зала. Первое фото станет обложкой в
              каталоге.
            </p>
          </CardContent>
        </Card>
